...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> Home <span class="c-gray en">&gt;</span> Supplier Listing  <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="Reload" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c">
		<form class="form form-horizontal" id="form-supplier">
			<div class="row cl">
                <label class="form-label col-xs-2">Supplier Name</label>
                <div class="formControls col-xs-4">
                	<input type="hidden" ng-model="supplier.id">
                    <input type="text" ng-model="supplier.name" datatype="*4-50" class="input-text">
                </div>
                <label class="form-label col-xs-2">Contact Person</label>
                <div class="formControls col-xs-4">
                    <input type="text" ng-model="supplier.contactPerson" datatype="*4-50" class="input-text">
                </div>
			</div>
			<div class="row cl">
                <label class="form-label col-xs-2">Telephone</label>
                <div class="formControls col-xs-2">
                    <input type="text" ng-model="supplier.telephone" datatype="*4-50" class="input-text">
                </div>
                <label class="form-label col-xs-2">Fax</label>
                <div class="formControls col-xs-2">
                    <input type="text" ng-model="supplier.fax" datatype="*4-50" class="input-text">
                </div>
                <label class="form-label col-xs-2">Email</label>
                <div class="formControls col-xs-2">
                    <input type="text" ng-model="supplier.contactPersonEmail" datatype="*4-50" class="input-text">
                </div>
			</div>
			<div class="row cl">
                <label class="form-label col-xs-2">PostalCode</label>
                <div class="formControls col-xs-2">
                    <input type="text" ng-model="supplier.addPostal" datatype="*4-50" class="input-text">
                </div>
                <label class="form-label col-xs-2">Address</label>
                <div class="formControls col-xs-6">
                    <input type="text" ng-model="supplier.address1" datatype="*4-50" class="input-text">
                </div>
			</div>
			<div class="row cl">
...
<script type="text/javascript">
	...
	function Ctrl($scope, $http, $filter){
		...
		$scope.columns = [ 
            ...
            ,{"title":"supplier Name", width:"15%", className: "text-c", "visible":true, "data": "name"}

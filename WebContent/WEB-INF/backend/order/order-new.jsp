...
<div class="page-container">
	...
	<expander class='expander' ng-repeat='delivery in Delivery4' expander-title='delivery.title'>
        ...
        <div class="formControls col-xs-3">
            <span class="select-box">
				<select ng-model="delivery.menuId" class="select" style="width:100%;" ng-change="selectedMenu(delivery.menuGroupId, delivery.menuId)">
...
<div id="menuItemDiv" style="display: none;">
	<div class="check-box"
 		ng-repeat="item in menuItemList | filter:{menuGroupId: currentMenuGroupId, menuId: currentMenuId} track by item.code">
		<label>
		<input type="checkbox">
